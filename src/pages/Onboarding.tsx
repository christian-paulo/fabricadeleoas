          ...
          <div className="flex gap-3 w-full animate-[fade-in_0.4s_ease-out_0.2s_both]">
            ...
            <div className="flex-1 rounded-2xl border-2 border-primary pink-gradient p-4 flex flex-col items-center shadow-lg">
              <div className="w-full h-32 rounded-xl mb-3 overflow-hidden flex items-center justify-center bg-primary/20">
                <img src="/images/logo-branca.webp" alt="Fábrica de Leoas" className="h-24 w-auto" />
              </div>
  ...
  <div className="min-h-screen bg-background flex flex-col max-w-lg mx-auto">
    ...
    <div className="flex-1 flex flex-col items-center justify-center px-6 text-center">
      ...
      <p className="text-muted-foreground mb-4 leading-relaxed">
        Milhares de mulheres já <strong className="text-primary">transformaram seus corpos</strong> com a <strong className="text-primary">Fábrica de Leoas</strong>. 
        Com <strong className="text-primary">consistência</strong> e o <strong className="text-primary">protocolo personalizado</strong> para a sua realidade, você também vai chegar lá. 💪
      </p>
