  ...
  <div className="min-h-screen bg-background flex flex-col max-w-lg mx-auto">
    ...
    <div className="flex-1 flex flex-col items-center justify-center px-6 text-center">
      ...
      <p className="text-muted-foreground mb-4 leading-relaxed">
        Milhares de mulheres já <strong className="text-foreground">transformaram seus corpos</strong> com a <strong className="text-foreground">Fábrica de Leoas</strong>. 
        Com <strong className="text-foreground">consistência</strong> e o <strong className="text-foreground">protocolo personalizado</strong> para a sua realidade, você também vai chegar lá. 💪
      </p>
